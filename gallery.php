      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Gallery</h1>
              <p class="mb-0">Explore our gallery and get inspired! From stunning instruments to snapshots of musical journeys, our collection showcases the heart and soul of Melody Station. Dive in and let the music speak for itself!</p>
              <a href="contact.php" class="cta-btn">Discover the Rhythm of Melody Station<br></a>
            </div>
          </div>
        </div>
      </div>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">melodyStation</a>
      </div>
    </div>
