      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Contact</h1>
              <p class="mb-0">We’re here to help you make music! Whether you have questions about our rental plans, need assistance selecting the right instrument, or just want to share your feedback, we’d love to hear from you.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row gy-5">
            ...
            <div class="col-lg-4">
              <div class="info-item d-flex align-items-center">
                ...
                <div>
                  <h3>Location</h3>
                  <p>A108 Adam Street, Colombo, Sri Lanka</p>
                </div>
              </div>
            </div><!-- End Info Item -->
