      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center" data-aos="fade-up" data-aos-delay="100">
            <h2><span>At </span><span class="underlight">Melody Station</span> we believe<span> that music is for everyone</span></h2>
            <p style="font-family: 'Times New Roman'; font-style: italic; font-size: 20px;">we offer a wide range of instruments to suit every need. With flexible rental plans, renting your dream instrument is simple. Rent, play, and return – the music never stops with Melody Station!</p>
            <a href="services.php" class="btn-get-started">Discover Your Sound<br></a>
          </div>
        </div>
      </div>
